...
public:
    ...
    static constexpr uint16_t PM_OCEAN      = std::numeric_limits<uint16_t>::max() - 0;
    static constexpr uint16_t PM_IMPASSABLE = std::numeric_limits<uint16_t>::max() - 1;
    static constexpr uint16_t REAL_ID_MAX   = std::numeric_limits<uint16_t>::max() - 2;
